...
const CabPoolLanding = () => {
  ...
  const handleRegisterSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://cabpool.onrender.com/api/register",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        setRegisterForm({ name: "", email: "", phone: "", pickup_point: "", drop_point: "", message: "" });
      } else {
        setRegisterStatus("error");
      }
    } catch (error) {
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      // Simulate API call - replace with actual endpoint
      const response = await fetch(
        "https://cabpool.onrender.com/api/feedback",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const testimonials = [
    {
      ...
      comment:
        "CabPool saved me $300 last month on my daily commute. The matching system is incredibly smart!",
      rating: 5,
    },
    {
      name: "Mike Rodriguez",
      ...
      comment:
        "Finally, a ride-sharing service that actually makes financial sense. Clean cars, verified drivers.",
      rating: 5,
    },
    {
      name: "Emily Davis",
      role: "Consultant",
      comment:
        "I love how I can meet new people on my route while saving money. Win-win!",
      rating: 5,
    },
  ];
      ...
      <section className="pt-20 pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            Join thousands of smart commuters already saving money and making
            connections.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <a
              href="#Register"
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center"
            >
              Start Saving Today
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Getting started is simple. Discover a better way to commute and save
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Simply enter your pickup and drop-off locations. Our smart
                algorithm finds the most efficient route for everyone.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                We match you with verified commuters traveling similar routes.
                Chat with potential ride partners before booking.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Split costs automatically and transparently. Save up to 60%
                compared to solo rides while making new connections.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                inspections. Your safety is our top priority.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                No hidden fees or surge pricing. See exactly how costs are split
                before you book. Fair pricing for everyone.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our AI-powered matching system finds the perfect ride partners
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl opacity-90">
              Join now and start saving on your everyday travel
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  type="tel"
                  value={registerForm.pickup_point}
                  required
                  onChange={(e) =>
                    setRegisterForm({ ...registerForm, pickup_point: e.target.value })
                  }
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              ...
              <div>
                ...
                <input
                  type="tel"
                  value={registerForm.drop_point}
                  required
                  onChange={(e) =>
                    setRegisterForm({ ...registerForm, drop_point: e.target.value })
                  }
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Making commuting smarter, safer, and more affordable for
                everyone. Join the ride-sharing revolution today.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2025 CabPool. All rights reserved. Built with PERN stack.
            </p>
          </div>
        </div>
      </footer>
